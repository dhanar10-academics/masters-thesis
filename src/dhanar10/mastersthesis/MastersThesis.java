...
public class MastersThesis {
	...
	public static void main(String[] args) {
		...
		{
			//result[i] = mt.experiment01(); 	// RPROP 1,4,6,5
			//result[i] = mt.experiment02(); 	// RPROP 1,4,6
			//result[i] = mt.experiment03(); 	// RPROP 1,4
			//result[i] = mt.experiment04(); 	// RPROP 1
			//result[i] = mt.experiment05(); 	// BEE+RPROP 1,4,6,5
			//result[i] = mt.experiment06(); 	// BEE+RPROP 1,4,6
			//result[i] = mt.experiment07(); 	// BEE+RPROP 1,4
			result[i] = mt.experiment08(); 		// BEE+RPROP 1
		}
	...
	public void experiment00() {
		double[][] data = Utils.load("data.csv", 1);
